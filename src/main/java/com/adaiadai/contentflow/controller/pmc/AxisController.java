package com.adaiadai.contentflow.controller.pmc;

import com.adaiadai.contentflow.application.pmc.AxisApplicationService;
...
public class AxisController {
     ...
     * @return 模型视图
     */
    @GetMapping("product/{blogId}/project")
    public ModelAndView listInBtnByBlog(@PathVariable String blogId, Model model) {
