...
import com.adaiadai.contentflow.repository.ccp.SnippetJpaRepository;
import lombok.Data;
...
public class SnippetCardVO extends SnippetBaseVO {
     ...
     * @see SnippetJpaRepository#findAllByScope(Integer, Pageable)
     * @see SnippetJpaRepository#findAllByTitleContainingOrDescriptionContainingAndScope(String, String, Integer, Pageable)
     */
